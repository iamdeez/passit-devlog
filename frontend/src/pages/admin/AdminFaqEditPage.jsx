...
import { getFaqDetail, updateFaq, deleteFaq } from "../../api/services/faqService";
...
const AdminFaqEditPage = () => {
  ...
  const [form, setForm] = useState({ question: "", answer: "", category: "기타", is_visible: true });
    ...
    getFaqDetail(faqId)
      .then((data) => {
        ...
        setForm({
          ...
          answer: dto?.answer ?? "",
          category: dto?.category ?? dto?.type ?? "기타",
    ...
    <AdminLayout>
      <div className="p-6 md:p-8 max-w-3xl">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-xl font-display font-bold text-on-surface flex-1">FAQ 수정</h1>
